...
class PlayingCardView: UIView {
    ...
    @objc func adjustFaceCardScale(byHandlingGestureRecognized recognizer: UIPinchGestureRecognizer) {
...
extension PlayingCardView {
    private struct SizeRatio {
        ...
        static let cornerRadiusToBoundsHeight: CGFloat = 0.006
